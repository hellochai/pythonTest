...
# 使用DecisionTreeClassifier 是能够在数据集上执行多分类的类，与其他分类器一样，采用输入两个数组： 数组X，用[n_samples, n_features]的方式来存放训练样本，
# 正数组Y，用[n_sample] 来保存训练样本的类标签
from collections import namedtuple

from sklearn import tree
import graphviz

X = [[0, 0], [0, 1], [1, 2], [1, 2], [1, 4], [2, 2], [2, 3], [2, 4]]
Y = [0, 1, 2, 3, 4, 5, 6, 7]
...
# 决策通过使用DecisionTreeRegressor类解决回归问题.
...
print("predict2:", clf.predict([[1, 1]]))
